...
const pretty_1 = require("../compilers/pretty");
const _hooks_1 = require("../hooks/index.js");
function ViewsPretty() {
    return __awaiter(this, void 0, void 0, function* () {
        const { mode } = (0, _hooks_1.useMode)();
        (0, clog_1.clogWorking)(_enums_1.Tasks.viewsPretty);
        if (mode === _enums_1.Mode.build) {
            yield (0, pretty_1.prettyHTML)();
        }
    });
}
exports.default = ViewsPretty;
